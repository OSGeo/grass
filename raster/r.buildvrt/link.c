...
void create_map(const struct input *inputs, int num_inputs,
                const char *output, struct Cell_head *cellhd, int maptype,
                DCELL dmin, DCELL dmax, int have_stats,
                struct R_stats *ostats, const char *title)
{
    ...
    Rast_format_history(&history, HIST_KEYWRD,
                        _("virtual raster generated by %s"),
                        G_program_name());
