...
int searching_parallel(double *length,
    ...
    double *gridGeom_stepy, double *gridGeom_deltx, double *gridGeom_delty);
...
double brad(double, double *bh, struct SunGeometryVarDay *sunVarGeom,
    struct SunGeometryVarSlope *sunSlopeGeom, struct SolarRadVar *sunRadVar);
...
void com_par_parallel(double *sunGeom_lum_C11,
    ...
    double *sunVarGeom_stepsinangle,
    double *sunVarGeom_stepcosangle, double *gridGeom_stepxy, double latitude);
...
void com_par_const_parallel(double longitTime,
    ...
    double *sunGeom_cosdecl, double *gridGeom_sinlat, double *gridGeom_coslat);
...
double lumcline2_parallel(double *sunGeom_timeAngle,
    ...
    double *gridGeom_delty, unsigned char *horizonpointer);
