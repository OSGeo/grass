...
The rules are:
<ul>
<li> lat/lon coordinates: elevation in meters;</li>
<li> Other coordinates: elevation in the same unit as the easting-northing coordinates.</li>
</ul>
...
and defined coordinate system (check it with the <a href="g.proj.html">
g.proj</a>
...
<i>step</i> to 4 minutes or less. <i>step</i><code>=0.05</code> is equivalent
...
In case of out of memory error (<code>ERROR: G_malloc: out of memory</code>), the
...
(<a href="http://skagit.meas.ncsu.edu/~jaroslav/trento/Hofierka_Jaroslav.pdf">PDF</a>)</li>
<li>
...
Dordrecht (D. Reidel), 3, 71, 81-83.</li>
<li>
Page, J., Albuisson, M., Wald, L. (2001). The European solar radiation atlas:
a valuable digital tool. Solar Energy, 71, 81-83.</li>
<li>
...
<a href="http://re.jrc.ec.europa.eu/pvgis/solres/solmod3.htm">Solar radiation and GIS</a></li>
</ul>
