...
int main(int argc, char *argv[])
{
    ...
    parm.dir->description = _("Name of an existing raster map layer in the user's " "current mapset search path containing directions of the maximum ROSes, " "clockwise from north (degree).");        /* TODO: clockwise from north? see r.ros */
    ...
    parm.least->label = _("Basic sampling window size needed to meet certain accuracy (3)");    /* TODO: what is 3 here? default? */
    ...
    parm.comp_dens->label = _("Sampling density for additional computing (range: 0.0 - 1.0 (0.5))");    /* TODO: again, what is 0.5?, TODO: range not set */
    ...
    parm.time_lag->label = _("Simulating time duration LAG (fill the region) (min)");   /* TODO: what does this mean? */
    ...
    flag.spotting->key = 's';
    flag.spotting->description =
        _("Consider spotting effect (for wildfires)");
