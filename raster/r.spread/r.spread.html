...
<em>spatial heterogeneity</em>, and</li>
...
<p>Options <code>spot_dist</code>, <code>w_speed</code> and <code>f_mois</code> must all
be given if the <code>-s</code> (spotting) flag is used.
