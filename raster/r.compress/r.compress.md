...
fields \"input map name\", \"data type\", \"name of data compression
method\", \"NULL file compression\" separated by the pipe character.
...
-   NULL: represents \"no data\" in raster maps; to be distinguished
    from 0 (zero) data value
...
-   `ZLIB` (DEFLATE, good speed and compression)
    -   with zlib compression levels (`export GRASS_ZLIB_LEVEL=X`):
        -1..9 (-1 is default which corresponds to ZLIB level 6)
...
*[r.info](r.info.html), [r.null](r.null.html),
[r.support](r.support.html)*

Compression algorithms: [bzip2](http://www.bzip.org/),
[LZ4](http://www.lz4.org/), [zlib](http://zlib.net/),
