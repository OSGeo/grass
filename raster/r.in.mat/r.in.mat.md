...
"<code>MatFile</code>" or the name specified respectively.
...
As there is no IEEE value for <code>NaN</code> in integer arrays, GRASS's null
value may be used to represent it within these maps. Usually Matlab will save
any integer based matrix with <code>NaN</code> values as a double-precision
...
<code>NaN</code> values in either floating point or double-precision floating point
...
<br>
Remember Matlab arrays are referenced as <code>(row,column)</code>,
i.e. <code>(y,x)</code>.
<br><br>
