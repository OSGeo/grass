...
accumulation input map is multiplied by <code>(tan(local
slope))<sup>mexp</sup></code> and then compared
...
by <code>(tan(local slope))<sup>mexp</sup></code> and then compared
...
<code>ERROR: Accumulation raster map is NULL but elevation map is not NULL</code>
...
<em><a href="r.param.scale.html">r.param.scale</a></em> <code>method=crosc</code>
...
<code>cat int,stream_type varchar(),type_code int,network int</code>. The
...
1989). URL: <a href="https://www.researchgate.net/publication/243781937_Using_the_AT_search_algorithm_to_develop_hydrologic_models_from_digital_elevation_data">
https://www.researchgate.net/publication/243781937_Using_the_AT_search_algorithm_to_develop_hydrologic_models_from_digital_elevation_data</a></li>
<li>Holmgren, P. (1994). <i>Multiple flow direction algorithms for
runoff modelling in grid based elevation models: An empirical
evaluation.</i>
<b>Hydrological Processes</b> Vol 8(4), pp 327-334. DOI: <a href="https://doi.org/10.1002/hyp.3360080405">10.1002/hyp.3360080405</a></li>
