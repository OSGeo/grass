...
the nature of the terrain and the digital elevation model used.</li>
...
depressionless digital elevation model to work.</li>

<li>
The flow direction map can be visualized with
<em><a href="d.rast.arrow.html">d.rast.arrow</a></em>.</li>
...
response simulation): User's manual. U.S. EPA-905/9-82-001, Chicago, IL, 54 p.</li>
...
Engr. and Remote Sens. 54: 1593-1600.</li>
...
control Agency and Washington D.C., USDA-Agricultural Research Service.</li>
</ul>
