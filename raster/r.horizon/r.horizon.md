...
-   point: as a series of horizon heights in the specified directions
    from the given point(s). The results are written to the stdout.
-   raster: in this case the output is one or more raster maps, with
    each point in a raster giving the horizon height in a specific
    direction. One raster is created for each direction.
...
Activating the **-l** flag allows to additionally print the distance to
each horizon angle.
...
the terrain. If so, the angle is increased to allow the line of sight to
...
Systems](http://www.isess.org/papers.asp?year=2007), Prague, 2007

Neteler M., Mitasova H., 2004. Open Source GIS: A GRASS GIS Approach,
[Springer](http://www.springer.com/geography/gis+cartography/book/978-0-387-35767-6),
New York. ISBN: 1-4020-8064-6, 2nd Edition 2004 (reprinted 2005), 424
pages

Project [PVGIS](http://re.jrc.ec.europa.eu/pvgis/), European Commission,
DG Joint Research Centre 2001-2007
...
GIS](http://www.blackwellpublishing.com/toc.asp?ref=1361-1682), 8(2),
175-190
