...
extern const char *rast_in_name, /* Name of the raster file to process.  */
    *rast_out_name;              /* Name of the raster output file.      */
extern int constrained;          /* Flag that forces quadtratic through  */
...
extern int fd_in, /* File descriptor for input and        */
    ...
    nprocs;       /* number of threads for parallel processing. */
