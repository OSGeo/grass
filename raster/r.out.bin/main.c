...
static void write_bil_hdr(const char *outfile, const struct Cell_head *region,
...
static void convert_cell(unsigned char *out_cell, const DCELL in_cell,
...
static void convert_row(unsigned char *out_buf, const DCELL * raster,
    int ncols, int is_fp, int bytes, int swap_flag, double null_val)
{
