...
int o_adev(const char *, const char *, const char *, int,
           struct Categories *);
int o_average(const char *, const char *, const char *, int,
              struct Categories *);
int o_divr(const char *, const char *, const char *, int,
           struct Categories *);
int o_kurt(const char *, const char *, const char *, int,
           struct Categories *);
...
int o_mode(const char *, const char *, const char *, int,
           struct Categories *);
int o_sdev(const char *, const char *, const char *, int,
           struct Categories *);
int o_skew(const char *, const char *, const char *, int,
           struct Categories *);
