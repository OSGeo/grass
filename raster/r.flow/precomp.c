...
interpolate_border (void)
{
    ...
    put(el, r, c, 3*get(el,r-1,c-1)-get(el,r-2,c-1)-get(el,r-1,c-2));
}

static void
reflect_and_sentinel (void)
{
    int row, col;
