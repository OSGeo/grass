...
r.colors \
    map=test_elev_int_1,test_elev_int_2,test_elev_int_3 \
...
r.colors -g \
    map=test_elev_int_2,test_elev_int_3 \
    color=difference && r.colors.out --o map=test_elev_int_3 \
...
r.colors \
    map=test_elev_double_1,test_elev_double_2,test_elev_double_3 \
...
r.colors -g \
    map=test_elev_double_2,test_elev_double_3 \
    color=difference && r.colors.out --o map=test_elev_double_3 \
