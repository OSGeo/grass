...
extern int v5dCreateSimple(const char *name,
    ...
    float westlon, float loninc, float bottomhgt, float hgtinc);
...
extern void v5dCompressGrid(int nr, int nc, int nl, int compressmode,
    ...
    float ga[], float gb[], float *minval, float *maxval);
...
extern int v5dReadCompressedGrid(v5dstruct * v,
    int time, int var, float *ga, float *gb, void *compdata);
...
extern int v5dWriteCompressedGrid(const v5dstruct * v,
    int time, int var, const float *ga, const float *gb, const void *compdata);
