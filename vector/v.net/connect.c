 ...
 */
int connect_arcs (struct Map_info *In, struct Map_info *Pnts, struct Map_info *Out, int nfield, double thresh)
{
    int narcs;
	...
	for (i = 0; i < seg; i++) {
	    Vect_append_point(Pout,
			      Pline->x[i], Pline->y[i], Pline->z[i]);
	}
