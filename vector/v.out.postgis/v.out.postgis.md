...
Access](http://www.opengeospatial.org/standards/sfa) specification for
details). Flag **-l** allows to export vector features as topological
elements stored in [PostGIS
Topology](http://postgis.refractions.net/docs/Topology.html) schema.
Note that topological export requires PostGIS version 2 or later.
...
*[v.external.out](v.external.out.html)* are ignored by *v.out.postgis*.
...
used [PostgreSQL driver](http://gdal.org/drv_pg.html) from
[OGR](http://gdal.org/) library through *[v.out.ogr](v.out.ogr.html)*
module.
...
elements* in [PostGIS
Topology](http://postgis.refractions.net/docs/Topology.html) schema.
PostGIS Topology extension uses three tables to store basic topological
elements which forms topological objects like areas or isles in GRASS
terminology. *Nodes* (0-dimensional topological elements) are stored in
\"node\" table, *edges* (1-dimensional elements) in \"edge\" table and
*faces* (2-dimensional elements) in \"face\" table.
...
Export vector map \"urbanarea\" as feature table \"urbanarea\" located
...
*[v.out.ogr](v.out.ogr.html)* module, *v.out.postgis* is using directly
PostGIS data provider which is part of GRASS vector engine. Beside that,
*v.out.postgis* is optimized for PostGIS export including topological
access to the data.
...
-   Support other simple feature types like GeometryCollection and
    others
-   Implement missing options from *[v.out.ogr](v.out.ogr.html)*:
    **-a**, **-s**, **-c**, **-p**, **-n**
...
-   [OGC Simple Feature
    Access](http://www.opengeospatial.org/standards/sfa) specification
-   [PostGIS Topology](http://postgis.net/docs/Topology.html)
    documentation
-   [GRASS-PostGIS data
...
*[v.out.ogr](v.out.ogr.html), [v.external](v.external.html),
[v.external.out](v.external.out.html), [v.in.ogr](v.in.ogr.html)*
