...
*[v.generalize](v.generalize.html)* offers much more functionality for
...
all small angles. If the *-c* flag is used with *v.clean \...
tool=rmsa*, the sequence of *rmsa,break,rmdupl* is automatically
repeated until no more small angles a left.

## NOTES

The user does **not** have to run *[v.build](v.build.html)* on the
...
The import of areas with *[v.in.ogr](v.in.ogr.html) -c* (no cleaning)
...
*[v.info](v.info.html), [v.build](v.build.html),
[g.gui.vdigit](g.gui.vdigit.html), [v.edit](v.edit.html),
[v.fill.holes](v.fill.holes.html), [v.generalize](v.generalize.html)*
