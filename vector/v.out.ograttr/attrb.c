...
int mk_att(int cat, struct field_info *Fi, int ncol, int *colctype,
           const char **colname, int doatt, int nocat, OGRFeatureH Ogr_feature,
           int *noatt, dbCursor *cursor, int *more, int *db_cat,
           int key_col_index)
{
    int j, ogrfieldnum;
    dbTable *Table;
