...
SPDX-FileCopyrightText: 2025-2026 GRASS Development Team
...
macro(generate_docs_list)
    ...
    if(NOT D_TARGET OR NOT D_DOC_FILES)
        message(
            FATAL_ERROR
            "TARGET >${D_TARGET}< or DOC_FILES >${D_DOC_FILES}< in not set"
        )
    endif()
    ...
    if(D_IMG_FILES)
        add_custom_command(
            ...
            COMMAND
                ${CMAKE_COMMAND} -E copy_if_different ${D_IMG_FILES}
        ...
        install(
            FILES ${D_IMG_FILES}
            DESTINATION ${GRASS_INSTALL_MKDOCSDIR}/source
        )
    endif()
endmacro()
...
function(generate_docs name)
    ...
    elseif(D_GUI_TARGET_NAME)
        ...
        set(py_script_file
            ${OUTDIR}/${GRASS_INSTALL_SCRIPTDIR}/${D_GUI_TARGET_NAME}${py}
        )
        ...
        add_custom_command(
            ...
            WORKING_DIRECTORY ${sourcedir}
            COMMAND
                ${grass_env_command} ${PYTHON_EXECUTABLE} ${py_script_file}
