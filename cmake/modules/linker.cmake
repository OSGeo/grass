macro(set_alternate_linker linker)
    if(
        NOT "${USE_ALTERNATE_LINKER}" STREQUAL "${USE_ALTERNATE_LINKER_OLD_CACHED}"
    )
        unset(LINKER_EXECUTABLE CACHE)
    endif()
    find_program(
        LINKER_EXECUTABLE
        ld.${USE_ALTERNATE_LINKER}
    ...
    if(LINKER_EXECUTABLE)
        ...
        message(
            FATAL_ERROR
            "Cannot find alternative linker ${USE_ALTERNATE_LINKER}"
        )
    endif()
endmacro()
...
if(
    ...
    set(USE_ALTERNATE_LINKER_OLD_CACHED
        ${USE_ALTERNATE_LINKER}
        CACHE INTERNAL
        "Previous value of USE_ALTERNATE_LINKER"
    )
endif()
