...
if(WITH_FHS)
    ...
    set(GRASS_INSTALL_DEMODIR "${GRASS_INSTALL_MISCDIR}/demolocation")
    ...
    set(GISBASE_DIR
        "${CMAKE_INSTALL_LIBDIR}/grass${GRASS_VERSION_MAJOR}${GRASS_VERSION_MINOR}"
    )
    set(GRASS_INSTALL_BINDIR "${GISBASE_DIR}/bin")
...
set(GRASS_ETCBINDIR "${GRASS_INSTALL_ETCBINDIR}")
set(GRASS_PYDIR "${GRASS_INSTALL_PYDIR}")
set(GRASS_GUIWXDIR "${GRASS_INSTALL_GRASS_GUIWXDIR}")
set(GRASS_MISCDIR "${GRASS_INSTALL_MISCDIR}")
...
set(RUNTIME_GRASS_MISCDIR "${OUTDIR}/${GRASS_INSTALL_MISCDIR}")
...
if(WITH_FHS)
    ...
    file(
        TO_NATIVE_PATH
        "${OUTDIR}/${GRASS_INSTALL_PYDIR}"
        GRASS_INSTALL_PYDIR_RUNTIME_PATH
    )
else()
    file(
        TO_NATIVE_PATH
        "${CMAKE_INSTALL_PREFIX}/${GRASS_INSTALL_PYDIR}"
        GRASS_INSTALL_PYDIR_PATH
    )
    file(
        TO_NATIVE_PATH
        "${OUTDIR}/${GRASS_INSTALL_PYDIR}"
...
message(
    STATUS
    "GRASS_INSTALL_PYDIR_RUNTIME_PATH ${GRASS_INSTALL_PYDIR_RUNTIME_PATH}"
)
...
file(
    TO_NATIVE_PATH
    "${OUTDIR}/${GRASS_INSTALL_GUIDIR}/wxpython"
    GUI_WXPYTHON_DIR
)
