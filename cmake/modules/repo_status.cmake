...
function(repo_status repo_dir)
    ...
    set(GRASS_VERSION_GIT "exported" PARENT_SCOPE)
    set(GRASS_HEADERS_GIT_HASH ${GRASS_VERSION_NUMBER} PARENT_SCOPE)
    string(TIMESTAMP GRASS_HEADERS_GIT_DATE ${time_format} UTC)
    set(GRASS_HEADERS_GIT_DATE ${GRASS_HEADERS_GIT_DATE} PARENT_SCOPE)
    ...
    if(git_rev_RV)
        ...
        set(GRASS_VERSION_GIT "${GRASS_VERSION_GIT}" PARENT_SCOPE)
    endif()
    ...
    if(git_hash_RV)
        ...
        set(GRASS_HEADERS_GIT_HASH "${GRASS_HEADERS_GIT_HASH}" PARENT_SCOPE)
    endif()

    execute_process(
        COMMAND
            ${GIT_EXECUTABLE} log -1 --pretty=format:%ct --
            "${CMAKE_SOURCE_DIR}/include"
        WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
