macro(generate_md)
  ...
  set(PGM_SOURCE ${PGM_SOURCEDIR}/${PGM_NAME}.md)
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E copy ${PGM_SOURCE}
            ${CMAKE_CURRENT_BINARY_DIR}/${PGM_NAME}.md
    COMMAND ${grass_env_command} ${PYTHON_EXECUTABLE} ${MKMARKDOWN_PY}
            ${PGM_NAME} > ${OUTDIR}/${GRASS_INSTALL_MKDOCSDIR}/${PGM_NAME}.md
    COMMAND ${copy_images_command}
    COMMAND ${CMAKE_COMMAND} -E remove
            ${CMAKE_CURRENT_BINARY_DIR}/${PGM_NAME}.md
    COMMENT "Creating ${OUTDIR}/${GRASS_INSTALL_MKDOCSDIR}/${PGM_NAME}.[md|1]")
  install(FILES ${OUTDIR}/${GRASS_INSTALL_MKDOCSDIR}/${PGM_NAME}.md
