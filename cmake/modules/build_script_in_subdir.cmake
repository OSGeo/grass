...
function(build_script_in_subdir dir_name)
  ...
  add_custom_command(
    ...
    COMMAND
      ${CMAKE_COMMAND} -DBINARY_DIR=${CMAKE_BINARY_DIR} -DG_NAME=${G_NAME}
      -DSRC_SCRIPT_FILE=${SRC_SCRIPT_FILE} -DSOURCE_DIR=${CMAKE_SOURCE_DIR}
      -DOUTPUT_FILE=${TRANSLATE_C_FILE} -P
  ...
  install(PROGRAMS ${GISBASE}/scripts/${G_NAME}${SCRIPT_EXT}
          DESTINATION scripts)
