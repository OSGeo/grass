...
function(build_script_in_subdir dir_name)
 ...
 if("${G_NAME}" MATCHES "^v[\.]")
   set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools/Vector)
 elseif("${G_NAME}" MATCHES "^r[\.]")
   set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools/Raster)
 elseif("${G_NAME}" MATCHES "^d[\.]")
   set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools/Display)
 elseif("${G_NAME}" MATCHES "^db[\.]")
   set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools/Database)
 elseif("${G_NAME}" MATCHES "^g[\.]")
   set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools/General)
 elseif("${G_NAME}" MATCHES "^i[\.]")
   set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools/Imagery)
 elseif("${G_NAME}" MATCHES "^m[\.]")
   set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools/Miscellaneous)
 elseif("${G_NAME}" MATCHES "^ps[\.]")
   set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools/PostScript)
 elseif("${G_NAME}" MATCHES "^r3[\.]")
   set_target_properties(${G_NAME} PROPERTIES FOLDER "Python/Tools/Raster 3D")
 elseif("${G_NAME}" MATCHES "^t[\.]")
    set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools/Temporal)
 else()
   set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools/Binaries)
 endif()

  # set_target_properties(${G_NAME} PROPERTIES FOLDER Python/Tools)
