...
function(build_gui_in_subdir dir_name)
    ...
    set(SRC_SCRIPT_FILE
        ${CMAKE_CURRENT_SOURCE_DIR}/${G_NAME}/${G_TARGET_NAME}.py
    )
    ...
    if(WIN32)
        ...
        configure_file(
            ...
            ${OUTDIR}/${GRASS_INSTALL_SCRIPTDIR}/${G_TARGET_NAME}.bat
            @ONLY
        )
    endif()
    ...
    if(UNIX)
        add_custom_command(
            ...
            COMMAND
                ${CMAKE_COMMAND} -E copy ${SRC_SCRIPT_FILE} ${OUT_SCRIPT_FILE}
    ...
    if(WITH_DOCS)
        ...
        if(EXISTS ${HTML_FILE})
            install(
                FILES ${OUTDIR}/${GRASS_INSTALL_DOCDIR}/${G_TARGET_NAME}.html
    ...
    if(WIN32)
        install(
            PROGRAMS ${OUTDIR}/${GRASS_INSTALL_SCRIPTDIR}/${G_TARGET_NAME}.bat
