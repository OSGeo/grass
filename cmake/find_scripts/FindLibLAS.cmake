...
if (LibLAS_INCLUDE_DIR)
  ...
  STRING(REGEX MATCH "#define +LIBLAS_VERSION_MAJOR +([0-9]+)" _dummy "${las_version_CONTENTS}")
  SET(LibLAS_VERSION_MAJOR "${CMAKE_MATCH_1}")
  string(REGEX MATCH "#define +LIBLAS_VERSION_MINOR +([0-9])" _dummy "${las_version_CONTENTS}")
  set(LibLAS_VERSION_MINOR "${CMAKE_MATCH_1}")
  string(REGEX MATCH "#define +LIBLAS_VERSION_REV +([0-9])" _dummy "${las_version_CONTENTS}")
