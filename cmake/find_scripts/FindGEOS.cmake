...
if(NOT GEOS_FOUND)
  ...
  #]]
        ...
        if(UNIX)
            ...
            if(APPLE)
                if(
                    CMAKE_FIND_FRAMEWORK MATCHES "FIRST"
            ...
            if(NOT GEOS_INCLUDE_DIR OR NOT GEOS_LIBRARY OR NOT GEOS_CONFIG)
                ...
                if(GEOS_CONFIG)
                    ...
                    if(
                        GEOS_VERSION_MAJOR LESS 3
                        OR (
                            GEOS_VERSION_MAJOR EQUAL 3
    ...
    if(GEOS_INCLUDE_DIR AND NOT GEOS_VERSION)
        ...
        string(
            REGEX MATCH "#define GEOS_VERSION \"[0-9]+\\.[0-9]+\\.[0-9]+"
            GEOS_VERSION
            ${VERSIONFILE}
        )
        string(
    ...
    if(GEOS_FOUND)
        ...
        set_target_properties(
            GEOS::geos_c
            PROPERTIES IMPORTED_LOCATION ${GEOS_LIBRARY}
        )
