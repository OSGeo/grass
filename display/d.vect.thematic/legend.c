...
void write_into_legend_file(const char *legfile, const char *icon,
                            ...
                            double stats_max, double *breakpoints,
                            int nbreaks, int size, struct color_rgb bcolor,
                            ...
                            int *frequencies, const char *topo)
{
    ...
    fprintf(fd, "%s|%d|ps|%d:%d:%d|%d:%d:%d|%d|%s|%d\n",
            icon, size, colors[nbreaks].r, colors[nbreaks].g,
            colors[nbreaks].b, bcolor.r, bcolor.g, bcolor.b, default_width,
