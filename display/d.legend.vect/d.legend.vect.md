...
### Thematic chart map with legend

Example showing how to display a legend for thematic charts created
with *d.vect.chart*. The legend information is generated by *d.vect.chart*
and rendered using *d.legend.vect*.

```sh
d.vect.chart map=firestations \
    columns=PUMPERS,TANKER,PUMPER_TAN,MINI_PUMPE \
    chart_type=pie \
    size=40 \
    legend_title="Firefighting equipment"

d.legend.vect symbol_size=20
```
