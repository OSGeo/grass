...
def _search_module(
    ...
    GUIRESDIR = os.getenv("GRASS_GUIRESDIR")
    filename = os.path.join(GUIRESDIR, "wxpython", "xml", "module_items.xml")
    ...
    filename_addons_s = os.path.join(os.getenv("GRASS_MISCDIR"), "modules.xml")
