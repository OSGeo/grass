...
The **Graphical Modeler** is a *[wxGUI](wxGUI.html)* component which
...
[![](g_gui_gmodeler_lower_toolbar.png){width="600"
height="354"}](g_gui_gmodeler_lower_toolbar.png)\
...
-   \(A\) raster data:
    ![raster](g_gui_gmodeler_raster.png){style="margin: 0px 0px -5px 0px"}
-   \(B\) relation:
    ![relation](g_gui_gmodeler_relation.png){style="margin: 10px 0px 0px 0px"}
-   \(C\) GRASS module:
    ![module](g_gui_gmodeler_modul.png){style="margin: 0px 0px -5px 0px"}
-   \(D\) loop:
    ![loop](g_gui_gmodeler_loop.png){style="margin: 15px 0px -5px 0px"}
-   \(E\) database table:
    ![db](g_gui_gmodeler_db.png){style="margin: 10px 0px -5px 0px"}
-   \(F\) 3D raster data:
    ![raster3D](g_gui_gmodeler_raster3d.png){style="margin: 10px 0px -5px 0px"}
-   \(G\) vector data:
    ![vector](g_gui_gmodeler_vector.png){style="margin: 10px 0px -5px 0px"}
-   \(H\) disabled GRASS module:
    ![module](g_gui_gmodeler_modulex.png){style="margin: 10px 0px -5px 0px"}
-   \(I\) comment:
    ![comment](g_gui_gmodeler_comment.png){style="margin: 10px 0px -5px 0px"}

[![](g_gui_gmodeler_model_classification.png){width="500"}](g_gui_gmodeler_model_classification.png)\
*Figure: A model to perform unsupervised classification using MLC
([i.maxlik](i.maxlik.html)) and SMAP ([i.smap](i.smap.html)).*

Another example:

[![](g_gui_gmodeler_model_usle.png){width="600"
height="284"}](g_gui_gmodeler_model_usle.png)\
...
[![](g_gui_gmodeler_model_landslides.png){width="600"
...
[![](g_gui_gmodeler_dlg_module.png){width="400"}](g_gui_gmodeler_dlg_module.png)\
...
[![](g_gui_gmodeler_parameter.png){width="500"}](g_gui_gmodeler_parameter.png)\
...
[![](g_gui_gmodeler_model_avg.png){width="600"
height="272"}](g_gui_gmodeler_model_avg.png)\
*Figure: A model to perform average statistics for zipcode zones.*

\

[![](g_gui_gmodeler_items.png){width="600"
height="330"}](g_gui_gmodeler_items.png)

[![](g_gui_gmodeler_python.png){width="600"
height="330"}](g_gui_gmodeler_python.png)\
...
[![](g_gui_gmodeler_avg_run.png){width="500"}](g_gui_gmodeler_avg_run.png)
[![](g_gui_gmodeler_avg_map.png){width="300"}](g_gui_gmodeler_avg_map.png)\
...
[![](g_gui_gmodeler_model_properties.png){width="350"}](g_gui_gmodeler_model_properties.png)\
...
[![](g_gui_gmodeler_variables_run.png){width="500"}](g_gui_gmodeler_variables_run.png)\
...
[![](g_gui_gmodeler_variables.png){width="600"
height="330"}](g_gui_gmodeler_variables.png)\
*Figure: Example of raster file variable settings.*

\

[![](g_gui_gmodeler_variables_raster.png){width="600"
...
[![](g_gui_gmodeler_intermediate_data.png){width="400"}](g_gui_gmodeler_intermediate_data.png)\
...
[![](g_gui_gmodeler_python_code.png){height="500"}](g_gui_gmodeler_python_code.png)
[![](g_gui_gmodeler_python_code_result.png){height="500"}](g_gui_gmodeler_python_code_result.png)\
...
[![](g_gui_gmodeler_pywps_code.png){width="500"}](g_gui_gmodeler_pywps_code.png)\
...
[![](g_gui_gmodeler_actinia_code.png){width="500"}](g_gui_gmodeler_actinia_code.png)\
...
[![](g_gui_gmodeler_loop_dlg.png){width="300"}](g_gui_gmodeler_loop_dlg.png)\
...
[![](g_gui_gmodeler_loop_final.png){width="400"}](g_gui_gmodeler_loop_final.png)\
*Figure: Model with loop.*

[![](g_gui_gmodeler_modis_1o.png){width="300"}](g_gui_gmodeler_modis_1o.png)
[![](g_gui_gmodeler_modis_1.png){width="300"}](g_gui_gmodeler_modis_1.png)
[![](g_gui_gmodeler_modis_2o.png){width="300"}](g_gui_gmodeler_modis_2o.png)\
[![](g_gui_gmodeler_modis_2.png){width="300"}](g_gui_gmodeler_modis_2.png)
[![](g_gui_gmodeler_modis_3o.png){width="300"}](g_gui_gmodeler_modis_3o.png)
[![](g_gui_gmodeler_modis_3.png){width="300"}](g_gui_gmodeler_modis_3.png)\
*Figure: MODIS data representation in GRASS GIS after Graphical Modeler
usage.*
...
repository](https://grass.osgeo.org/grass78/manuals/addons/).
