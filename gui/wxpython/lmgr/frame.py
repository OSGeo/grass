...
class GMFrame(wx.Frame):
    ...
    def _createDisplay(self, parent):
        ...
        self.notebookLayers.SetActiveTabColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOW))
        self.notebookLayers.SetActiveTabTextColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
