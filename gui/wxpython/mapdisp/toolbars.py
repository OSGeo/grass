    ...
    def _toolbarData(self):
        ...
        return self._getToolbarData(
            (
                ...
                (
                    ("select", _("Select vector feature(s)")),
                    MapIcons["select"],
                    self.parent.OnSelect,
                    wx.ITEM_CHECK,
                ),
                (
                    ("query", _("Query raster/vector map(s)")),
                    MapIcons["query"],
                    self.parent.OnQuery,
                    wx.ITEM_CHECK,
                ),
                ...
                (
                    ("zoomExtent", _("Zoom to selected map layer(s)")),
                ...
                (
                    ("analyze", _("Analyze map")),
                    MapIcons["analyze"],
                    self.OnAnalyze,
                ),
                (
                    ("overlay", _("Add map elements")),
                    BaseIcons["overlay"],
                    self.OnDecoration,
                ),
                (
