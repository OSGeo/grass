...
class MapToolbar(BaseToolbar):
    ...
    def _toolbarData(self):
        ...
        return self._getToolbarData((
            (('renderMap', _('Render map')), BaseIcons['render'],
             self.parent.OnRender),
            (('pointer', _('Pointer')), BaseIcons['pointer'],
             self.parent.OnPointer,
             wx.ITEM_CHECK),
            (('select', _('Select')), MapIcons['select'],
             self.parent.OnSelect,
             wx.ITEM_CHECK),
            (('query', _('Query')), MapIcons['query'],
             self.parent.OnQuery,
             wx.ITEM_CHECK),
            (('pan', _('Pan')), BaseIcons['pan'],
             self.parent.OnPan,
             wx.ITEM_CHECK),
            (('zoomIn', _('Zoom in')), BaseIcons['zoomIn'],
             self.parent.OnZoomIn,
             wx.ITEM_CHECK),
            (('zoomOut', _('Zoom out')), BaseIcons['zoomOut'],
             self.parent.OnZoomOut,
             wx.ITEM_CHECK),
            (('zoomExtent', _('Zoom extent')), BaseIcons['zoomExtent'],
             self.parent.OnZoomToMap),
            (('zoomRegion', _('Zoom region')), BaseIcons['zoomRegion'],
             self.parent.OnZoomToWind),
            (('zoomBack', _('Zoom back')), BaseIcons['zoomBack'],
             self.parent.OnZoomBack),
            (('zoomMenu', _('Zoom menu')), BaseIcons['zoomMenu'],
             self.parent.OnZoomMenu),
            (('analyze', _('Analyze')), MapIcons['analyze'],
             self.OnAnalyze),
            (('overlay', _('Overlay')), BaseIcons['overlay'],
             self.OnDecoration),
            (('saveFile', _('Save file')), BaseIcons['saveFile'],
