    ...
    def _toolbarData(self):
        ...
        return self._getToolbarData(
            (
                ...
                (("pan", _("Pan")), BaseIcons["pan"], self.parent.OnPan, wx.ITEM_CHECK),
                (
                    ("zoomIn", _("Zoom in")),
                    BaseIcons["zoomIn"],
                ...
                (
                    ("zoomRegion", _("Zoom to region")),
                    BaseIcons["zoomRegion"],
                    self.parent.OnZoomToWind,
                ),
                (
                    ("zoomBack", _("Zoom back")),
                    BaseIcons["zoomBack"],
                ...
                (("analyze", _("Analyze")), MapIcons["analyze"], self.OnAnalyze),
                (("overlay", _("Overlay")), BaseIcons["overlay"], self.OnDecoration),
                (
