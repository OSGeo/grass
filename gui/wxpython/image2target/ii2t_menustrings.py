...
menustrings_menudata.LayerManagerMenuData = [
    ...
    _('Manage maps'),
    _('Copy'),
    _("Copies available data files in the current subproject search path to the user's current subproject."),
    _('List'),
    ...
    _('Delete'),
    _("Removes data base element files from the user's current subproject using the search pattern."),
    ...
    _('Subproject access'),
    _('Set/unset access to other subprojects in current project'),
    _('User access'),
    _('Controls access to the current subproject for other users on the system. If no option given, prints current status.'),
    _('Change working environment'),
    _('Changes/reports current subproject. Optionally create new subproject or list available subprojects in given project.'),
    _('Change project and subproject'),
    _('Change current project and subproject.'),
    _('Change subproject'),
    _('Change current subproject.'),
    ...
    _('Launches project wizard to create new GRASS project.'),
    _('Create new subproject'),
    _('Creates new subproject in the current project, changes current subproject.'),
    ...
    _('Prints or modifies GRASS projection information files (in various co-ordinate system descriptions). Can also be used to create new GRASS projects.'),
    ...
    _('Cost surface'),
    _('Creates a raster map showing the cumulative cost of moving between different geographic projects on an input raster map whose cell category values represent cost.'),
    _('Cumulative movement costs'),
    _('Creates a raster map showing the anisotropic cumulative cost of moving between different geographic projects on an input raster map whose cell category values represent cost.'),
    ...
    _('Rebuilds topology on all vector maps in the current subproject.'),
    _('Build polylines'),
    ...
    _('Queries a vector map at given projects.'),
    ...
    _('Sample raster maps at point projects'),
    ...
    _('Spectral response'),
    _('Displays spectral response at user specified projects in group or images.'),
    _('Pan sharpening'),
    ...
    _('Reconnects attribute tables for all vector maps from the current subproject to a new database.'),
    ...
    _('Observe specific projects in raster dataset'),
    _('Observes specific projects in a space time raster dataset over a period of time using vector points.'),
    _('Temporal sampling'),
