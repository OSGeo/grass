...
menustrings_LayerManagerMenuData = [
    _("&File"),
    _("Workspace"),
    _("New"),
    ...
    _("Simplified raster import with reprojection"),
    _("Imports raster data into a GRASS raster map using GDAL library."),
    _("Import of common raster formats"),
    _("Imports raster data into a GRASS raster map using GDAL library."),
    ...
    _("LAS LiDAR points import"),
    _("Converts LAS LiDAR point clouds to a GRASS vector map with libLAS."),
    _("Point cloud (LAS LiDAR) import"),
    _("Module not installed"),
    _("Unpack vector map"),
    _(
    ...
    _("Reproject vector map from different GRASS project"),
    ...
    _(
        "Redirects raster output to file utilizing GDAL library rather than storing in "
        "GRASS raster format."
    ),
    ...
    _("Simple Python Editor"),
    _("Launches Simple Python Editor."),
    _("Close GUI"),
    ...
    _("Shows the extent and resolution of the computational region."),
    _("Show current region extent in Map Display"),
    _("Shows the extent of the computational region in Map Display."),
    _("Set region"),
    _("Manages the boundary definitions for the geographic region."),
    _("GRASS working environment"),
    _("Mapset access"),
    _("Set/unset access to other mapsets in current project"),
    _("User access"),
    _(
    ...
    _("Change project (location) and mapset"),
    _("Change current project and mapset."),
    _("Change mapset"),
    ...
    _("Create new project (location)"),
    _(
        "Launches project wizard to create a new GRASS project (also known as "
        "location)."
    ),
    _("Create new mapset"),
    _("Creates new mapset in the current project, changes current mapset."),
    _("Map projections"),
    ...
    _(
        "Prints or modifies GRASS projection information files (in various co-ordinate "
        "system descriptions). Can also be used to create new GRASS projects."
    ),
    ...
    _(
        ...
        "map to a new raster map (possibly with different resolution) using "
    ...
    _(
        "Generates a raster map containing distances to nearest raster features and/or "
        "the value of the nearest non-null cell."
    ),
    _("Mask"),
    _("Creates a MASK for limiting raster operation."),
    _("Raster map calculator"),
    _("Simplified raster map calculator"),
    _("Calculates a new raster map from a simple r.mapcalc expression."),
    _("Raster map calculator"),
    _("Raster map calculator."),
    ...
    _(
        "Makes each output cell value a accumulationfunction of the values assigned to "
    ...
    _(
        ...
        "the angle between the direction of the geometric center of the sun's apparent "
        "disk and the (idealized) horizon. Solar azimuth: the angle from due north in "
        "clockwise direction."
    ),
    _("Terrain analysis"),
    ...
    _(
        "Extracts terrain parameters from a DEM. Uses a multi-scale approach by taking "
        "fitting quadratic parameters to any size window (via least squares)."
    ),
    _("Textural features"),
    ...
    _(
        ...
        "single point whose coordinates are given with the 'coord' option. The horizon "
        "height (in radians). 2. Computes one or more raster maps of the horizon "
        "height in a single direction. The input for this is the angle (in degrees), "
        "which is measured counterclockwise with east=0, north=90 etc. The output is "
        "the horizon height in radians."
    ),
    ...
    _(
        "Dissolves adjacent or overlaping features sharing a common category number or "
        "attribute."
    ),
    ...
    _("Allocate subnets"),
    _(
        "Allocates subnets for nearest centers. Center node must be opened "
    ...
    _("Clip vector maps"),
    _("Extracts features of input map which overlay features of clip map."),
    _("Overlay vector maps"),
    _(
        "Overlays two vector maps offering clip, intersection, difference, symmetrical "
        "difference, union operators."
    ),
    _("Patch vector maps"),
    ...
    _("HIS to RGB"),
    _(
        "Transforms raster maps from HIS (Hue-Intensity-Saturation) color space to RGB "
        "(Red-Green-Blue) color space."
    ),
    _("RGB to HIS"),
    _(
        "Transforms raster maps from RGB (Red-Green-Blue) color space to HIS "
    ...
    _("Input for supervised SVM"),
    _("Module not installed"),
    _("Support Vector Machines classification (SVM)"),
    _("Module not installed"),
    _("Manage signature files"),
    _("Manage imagery classification signature files"),
    ...
    _(
        "Calculates Top of Atmosphere Radiance/Reflectance/Brightness Temperature from "
        "ASTER DN."
    ),
    ...
    _("Orthophoto tools"),
    _("Manage GCPs for 3D correction"),
    _("Georectifies a map and allows managing GCP for 3D correction."),
    _("Corrects scanning distortions"),
    _("Corrects scanning distortions of a scanned aerial photo."),
    ...
    _(
        "Creates/modifies the color table associated with each raster map of the space "
        "time raster dataset."
    ),
    ...
    _(
        "Performs different aggregation algorithms from r.series on all or a subset of "
        "raster maps in a space time raster dataset."
    ),
    ...
    _(
        "Calculates univariate statistics of attributes for each registered vector map "
        "of a space time vector dataset"
    ),
