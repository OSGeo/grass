menustrings_menudata.LayerManagerMenuData'> = [
    ...
    _('Unpack raster map'),
    _('Imports a GRASS GIS specific raster archive file (packed with r.pack) as a raster map'),
    ...
    _('Unpack vector map'),
    _('Imports a GRASS GIS specific vector archive file (packed with v.pack) as a vector map'),
    ...
    _('Export vector map'),
    _('Common export formats'),
    _('Exports a vector map layer to any of the supported OGR vector formats. By default a vector map layer is exported to OGC GeoPackage format.'),
    ...
    _('Allocate subnets'),
    _('Allocates subnets for nearest centers. Center node must be opened (costs >= 0). Costs of center node are used in calculation.'),
    _('Split net'),
    _('Splits subnets for nearest centers by cost isolines. Splits net to bands between cost isolines (direction from center). Center node must be opened (costs >= 0). Costs of center node are used in calculation.'),
    _('Shortest path'),
    ...
    _('Creates a Voronoi diagram constrained to the extents of the current region from an input vector map containing points or centroids.'),
    _('Generate grid'),
    ...
    _('Assigns timestamps and registers raster, vector and raster3d maps in a space time dataset.'),
...
menustrings_menudata.LayerManagerModuleTree'> = [
    ...
    _('Launches graphical attribute table manager.'),
    _('Cartographic Composer'),
    _('Launch Cartographic Composer'),
    _('Georectify'),
    _('Manage Ground Control Points for Georectification'),
