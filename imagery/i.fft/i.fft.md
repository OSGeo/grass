...
for the FFT". See <a href="https://fftw.org">www.FFTW.org</a>: FFTW is a C subroutine library
for computing the Discrete Fourier Transform (DFT) in one or more
dimensions, of both real and complex data, and of arbitrary input size.</li>
<li> John A. Richards, 1986. Remote Sensing Digital Image Analysis, Springer-Verlag.</li>
<li>Personal communication, between program author and Ali R. Vali,
Space Research Center, <a href="https://www.utexas.edu">University of Texas</a>, Austin, 1990.</li>
</ul>
