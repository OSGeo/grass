...
class TestIGroup(TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Set up a temporary GRASS region and generate test raster maps."""
        cls.use_temp_region()
    ...
    def tearDownClass(cls):
        """Remove rasters and restore the original region."""
    ...
    def test_add_remove_maps(self):
        """Test that rasters can be added to and removed (-r and -g flag) from a group."""
        self.assertModule(
            "i.group",
            group=self.test_group,
    ...
    def test_subgroup_handling(self):
        """Test subgroup creation and listing of subgroup (-s flag) members."""
        self.assertModule(
            "i.group",
            group=self.test_group,
