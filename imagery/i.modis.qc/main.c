...
int main(int argc, char *argv[])
{
    ...
    productname->options =
        "mod09Q1,mod09A1,mod09A1s,mod09GA,mod09GAs,mod09CMG,mod09CMGs,mod09CMGi,mod11A1,mod11A2,mod13A2,mcd43B2,mcd43B2q,mod13Q1";
    ...
    G_asprintf(&desc_input_band,
        ...
        _("Band 3: Blue"),
        _("Band 4: Green"),
        _("Band 5: SWIR 1"), _("Band 6: SWIR 2"), _("Band 7: SWIR 3"));
    ...
    if (strcmp(product, "mod09Q1")      /*if not mod09Q1 but its qcflag was entered, issue error */
        &&(!strcmp(qcflag, "cloud") ||
            !strcmp(qcflag, "diff_orbit_from_500m")))
    ...
    if ((strcmp(qcflag, "BRDF_correction_performed") &&
            (!(strcmp(product, "mod09A1s")) ||
                !(strcmp(product, "mod09CMGs")))))
