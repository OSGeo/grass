...
int main(int argc, char *argv[])
{
    ...
    opt.sl_slope->description = _("Value of the slope of the soil line (MSAVI and PVI only)");
	...
	for (col = 0; col < ncols; col++)
	{
		...
		if (!strcasecmp(viflag, "msavi"))
		    outrast[col] = msa_vi(d_redchan, d_nirchan, soil_slope, soil_inter, soil_noise);
