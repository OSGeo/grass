...
website](http://modis-sr.ltdri.org/).
...
### A. Geometrical conditions
  ...
  **Code**                **Description**         **Details**
  ...
  1                       **meteosat**            enter month,day,decimal hour
                          observation             (universal time-hh.ddd)\
                                                                        n. of
                                                  column,n. of line. (full
                                                  scale 5000\*2500) 

  2                       **goes east**           enter month,day,decimal hour
                          observation             (universal time-hh.ddd)\
                                                                        n. of
                                                  column,n. of line. (full
                                                  scale 17000\*12000)c

  3                       **goes west**           enter month,day,decimal hour
                          observation             (universal time-hh.ddd)\
                                                                        n. of
                                                  column,n. of line. (full
                                                  scale 17000\*12000)

  4                       **avhrr** (PM noaa)     enter month,day,decimal hour
                                                  (universal time-hh.ddd)\
                                                                        n. of
                                                  column(1-2048),xlonan,hna\
                                                                        give
                                                  long.(xlonan) and overpass
                                                  hour (hna) at\
                                                                        the
                                                  ascendant node at equator

  5                       **avhrr** (AM noaa)     enter month,day,decimal hour
                                                  (universal time-hh.ddd)\
                                                                        n. of
                                                  column(1-2048),xlonan,hna\
                                                                        give
  ...
  25                      **Sentinel-2A**         enter
                                                  month,day,hh.ddd,long.,lat.
                                                  \*

  26                      **Sentinel-2B**         enter
                                                  month,day,hh.ddd,long.,lat.
                                                  \*

  27                      **PlanetScope 0c 0d**   enter
                                                  month,day,hh.ddd,long.,lat.
                                                  \*

  28                      **PlanetScope 0e**      enter
                                                  month,day,hh.ddd,long.,lat.
                                                  \*

  29                      **PlanetScope 0f 10**   enter
                                                  month,day,hh.ddd,long.,lat.
                                                  \*
  ...
  32                      **Hyperion VNIR**       enter
                                                  month,day,hh.ddd,long.,lat.
                                                  \*

  33                      **Hyperion SWIR**       enter
                                                  month,day,hh.ddd,long.,lat.
                                                  \*
  ----------------------- ----------------------- -----------------------------
...
### B. Atmospheric model
  ...
  **Code**                            **Meaning**
  ...
  7                                   Define your own atmospheric model
                                      as a set of the following 5
                                      parameters per each measurement:\
                                      \
                                      altitude \[km\]\
                                      pressure \[mb\]\
                                      temperature \[k\]\
                                      ...
                                      radiosonde measurement for each
                                      altitude of 0-25km at a step of
                                      1km, one measurement for each
                                      altitude of 25-50km at a step of
                                      5km, and two single measurements
                                      for altitudes 70km and 100km. This
                                      makes 34 measurements. In that
                                      case, there are 34\*5 values to
                                      input.

  8                                   Define your own atmospheric model
                                      providing values of the water vapor
                                      and ozone content:\
                                      \
                                      uw \[g/cm2\]\
                                      uo3 \[cm-atm\]\
...
### C. Aerosols model
  ...
  **Code**                **Meaning**             **Details**
  ...
  7                       define your own model   Enter the volumic
                                                  percentage of each
                                                  component:\
                                                  \
                                                  c(1) = volumic % of
  ...
  8                       define your own model   Size distribution
                                                  function: Multimodal
                                                  Log Normal (up to 4
                                                  modes).

  9                       define your own model   Size distribution
                                                  function: Modified
                                                  gamma.

  10                      define your own model   Size distribution
                                                  function: Junge
                                                  Power-Law.

  11                      define your own model   Sun-photometer
                                                  measurements, 50 values
                                                  max, entered as:\
                                                  \
                                                  r and d V / d (logr)\
                                                  \
...
Define your own spectral conditions:
  ...
  **Code**                            **Meaning**
  ...
  -2                                  Enter wlinf, wlsup.\
                                      The filter function will be equal
                                      to 1 over the whole band (as
                                      iwave=0) but step by step output
                                      will be printed.

  -1                                  Enter wl (monochr. cond, gaseous
                                      absorption is included).

  0                                   Enter wlinf, wlsup.\
                                      The filter function will be equal
                                      to 1 over the whole band.

  1                                   Enter wlinf, wlsup and user\'s
                                      filter function s (lambda) by step
                                      of 0.0025 micrometer.
  ----------------------------------- -----------------------------------
...
Pre-defined satellite bands:
  ...
  **Code**   **Band name (peak response)**
  ...
  208        AVIRIS b1 band (365nm)
  209        AVIRIS b2 band (375nm)
  .          AVIRIS b. band (+10nm)
...
[r.import](r.import.html)) into the *PERMANENT* mapset of the North
...
-   **rescale** = the output range of values for the corrected bands.
    This is up to the user to choose, for example: 0-255, 0-1, 1-10000.
...
[![i.atcorr example](i_atcorr_B02_atcorr.png){width="600" height="486"
border="0"}](i_atcorr_B02_atcorr.png)\
...
file ([file
copy](http://www.grassbook.org/wp-content/uploads/ncexternal/landsat/2002/p016r035_7x20020524.met);
...
-   Lλ = Spectral Radiance at the sensor\'s aperture in Watt/(meter
    squared \* ster \* µm), the apparent radiance as seen by the
    satellite sensor;
...
[Landsat
handbook](http://landsathandbook.gsfc.nasa.gov/pdfs/Landsat7_Handbook.pdf),
...
[i.landsat.toar](i.landsat.toar.html), [r.info](r.info.html),
...
sources](http://6s.ltdri.org/), addition 07/2011:*\
Alfredo Alessandrini, Anne Ghisla

*Added Landsat 8 from [NASA
sources](http://landsat.gsfc.nasa.gov/?p=5779), addition 05/2014:*\
Nikolaos Ves
