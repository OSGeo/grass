...
<ol>
<li> The Fourier transform of the image is taken,</li>
<li> The Fourier transform of the Laplacian of a two-dimensional
Gaussian function is used to filter the transformed image,</li>
<li> The result is run through an inverse Fourier transform,</li>
<li> The resulting image is traversed in search of places where the image
changes from positive to negative or from negative to positive,</li>
...
The resulting raster map layer is output.</li>
</ol>
