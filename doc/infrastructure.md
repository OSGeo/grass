...
written by M. Neteler - last changed: Sep 2023
...
Old trac related notes:

- For easier linking in the Trac Wiki, some macro definitions are
  used for manual page refs (G8:modulename):
  - <https://trac.osgeo.org/grass/wiki/InterMapTxt>
- ZIP file download support in trac (was needed for g.extension)
  on trac.osgeo.org:
...
- OLD, UNUSED: grass-qa is receiving posts from the GRASS Quality Control
  System at Ecole Polytechnique de Montreal, Canada. Not open for other postings.
...
- offline, kept here for historical reasons.
