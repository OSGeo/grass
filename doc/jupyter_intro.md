...
*Figure 1: Jupyter Startup Dialog - Choose notebook storage and template options*
...
![Browser Mode Panel](jupyter_browser_mode.png)
*Figure 2: Browser Mode - Opens Jupyter in your default web browser*
...
![Integrated Mode](jupyter_integrated_mode.png)
*Figure 3: Integrated Mode - Jupyter embedded directly in GRASS GUI*
