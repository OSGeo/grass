...
struct proj_unit *get_proj_unit(const char *arg)
{
    ...
    snprintf(buf, sizeof(buf), "%s/proj/units.table", G_etc_dir());
...
struct proj_desc *get_proj_desc(const char *arg)
{
    ...
    snprintf(buf, sizeof(buf), "%s/proj/desc.table", G_etc_dir());
...
struct proj_parm *get_proj_parms(const char *arg)
{
    ...
    snprintf(buf, sizeof(buf), "%s/proj/parms.table", G_etc_dir());
