...
class InteractiveMap():
    ...
    def __init__(self, width=400, height=400):
        ...
        rcfile, self._vector_env = gs.create_environment(self.tmp_dir, "temp_folium_WGS84", "PERMANENT")       
        
        # Location and mapset and region
        gs.create_location(self.tmp_dir, "temp_folium_WGS84", epsg="4326", overwrite=True)
    ...
    def add_vector(self, name):
        ...
        gs.run_command("v.out.ogr", input=name, output=json_file, format="GeoJSON", env=self._vector_env)
