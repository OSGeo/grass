...
class Bbox:
    ...
    def contains(self, point):
        ...
        """
        return bool(
            libvect.Vect_point_in_box(point.x, point.y, point.z if point.z else 0, self.c_bbox)
        )
...
class CatsList:
    ...
    def __init__(self, c_cat_list=None):
        self.c_cat_list = c_cat_list if c_cat_list else ctypes.pointer(libvect.cat_list())
