...
void Vect_line_buffer2(const struct line_pnts *, double, double, double, int,
    int, double, struct line_pnts **, struct line_pnts ***, int *);
void Vect_area_buffer2(const struct Map_info *, int, double, double, double,
    int, int, double, struct line_pnts **, struct line_pnts ***, int *);
...
int Vect_get_point_in_poly_isl(const struct line_pnts *,
    const struct line_pnts **, int, double *, double *);
...
int Vect_net_shortest_path_coor(struct Map_info *, double, double, double,
    ...
    struct line_pnts *, struct line_pnts *, double *, double *);
...
int Vect_copy_table_by_cat_list(const struct Map_info *, struct Map_info *,
    int, int, const char *, int, const struct cat_list *);
...
int Vect_line_intersection(struct line_pnts *, struct line_pnts *,
    ...
    struct line_pnts ***, struct line_pnts ***, int *, int *, int);
...
int Vect_write_ascii(FILE *, FILE *, struct Map_info *, int,
    ...
    int, const struct cat_list *, const char *, const char **, int);
...
unsigned char *Vect_read_line_to_wkb(const struct Map_info *,
    struct line_pnts *, struct line_cats *, int, size_t *, int *);
#endif
