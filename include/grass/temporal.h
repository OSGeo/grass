...
void tgis_dataset_list_insert(tgisDatasetList * list, char *name,
                              char *mapset, char *creator,
                              DateTime * creation_time, char temporal_type,
                              struct TimeStamp *ts, tgisExtent * extent,
                              void *metadata, char dataset_type,
                              char is_stds);
...
int tgis_build_topology2(tgisDatasetList * A, tgisDatasetList * B,
                         char spatial);
...
tgisDataset *tgis_get_stds_info(char *stds_name, char *mapset,
                                char stds_type);
