...
***************************************************************
***************************************************************/
template < class T > class pqheap_t1 {
...
//************************************************************/
template < class T > inline pqheap_t1 < T >::pqheap_t1(unsigned int size)
{
...
//************************************************************/
template < class T > inline pqheap_t1 < T >::~pqheap_t1()
{
#ifdef HEAPSTATUS
...
//************************************************************/
template < class T > inline bool pqheap_t1 < T >::full(void)
{
    return cur_elts == max_elts;
}

//************************************************************/
template < class T > inline bool pqheap_t1 < T >::empty(void)
{
    return cur_elts == 0;
}

//************************************************************/
template < class T > inline unsigned int pqheap_t1 < T >::num_elts(void)
{
    return cur_elts;
}

//************************************************************/
template < class T > inline bool pqheap_t1 < T >::min(T & elt)
{
    if (!cur_elts) {
        return false;
    }
...
//************************************************************/
template < class T > T pqheap_t1 < T >::min()
{
    T elt;
...
//to 'insert' and then 'heapify', but it is enough to 'set'
template < class T > inline void pqheap_t1 < T >::set(long i, T & elt)
{
...
//************************************************************/
#ifdef HEAPSTATUS
template < class T > inline void pqheap_t1 < T >::heaptouch(unsigned int pos)
{
...
#ifdef HEAPSTATUS
template < class T > inline void pqheap_t1 < T >::heapstatus(int d)
{
    static int count = 0;
    static int delta = 0;
...
//************************************************************/
template < class T > inline bool pqheap_t1 < T >::extract_min(T & elt)
{
    if (!cur_elts) {
        return false;
    }
...
//************************************************************/
//extract all elts with min key, add them and return their sum
template < class T > inline bool pqheap_t1 < T >::extract_all_min(T & elt)
{
...
//************************************************************/
template < class T > inline bool pqheap_t1 < T >::delete_min()
{
    T dummy;
...
//************************************************************/
template < class T > inline bool pqheap_t1 < T >::insert(const T & elt)
{
    unsigned int ii;
...
//************************************************************/
template < class T > inline void pqheap_t1 < T >::heapify(unsigned int root)
{
...
/************************************************************/
template < class T > void pqheap_t1 < T >::print()
{
    cout << "[";
...
/************************************************************/
template < class T > void pqheap_t1 < T >::print_range()
{
    cout << "[";
    T a, b;
