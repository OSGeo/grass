...
template < class T > class AMI_STREAM:public UntypedStream {
...
template < class T > AMI_STREAM < T >::AMI_STREAM()
{
...
template < class T >
    ...
    off_t sub_begin, off_t sub_end, AMI_STREAM < T > **sub_stream)
{
...
/**********************************************************************/
// Return the number of items in the stream.
template < class T > off_t AMI_STREAM < T >::stream_len(void)
{
...
/**********************************************************************/
// Return the path name of this stream.
template < class T > AMI_err AMI_STREAM < T >::name(char **stream_name)
{
...
// Return the path name of this stream.
template < class T > const char *AMI_STREAM < T >::name() const
{
    return path;
}
...
template < class T > AMI_err AMI_STREAM < T >::seek(off_t offset)
{
...
/**********************************************************************/
template < class T > AMI_STREAM < T >::~AMI_STREAM(void)
{
...
/**********************************************************************/
template < class T > AMI_err AMI_STREAM < T >::read_item(T ** elt)
{
...
/**********************************************************************/
template < class T > AMI_err AMI_STREAM < T >::write_item(const T & elt)
{
...
/**********************************************************************/
template < class T > void AMI_STREAM < T >::persist(persistence p)
{
    per = p;
}
...
// if you are careful.
template < class T > char *AMI_STREAM < T >::sprint()
{
...
/**********************************************************************/
template < class T > int AMI_STREAM < T >::eof()
{
    return eof_reached;
}
