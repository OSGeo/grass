 ...
 */
template < class KEY > class merge_key {
  public:
    KEY k;
...
template < class T, class Key > class em_buffer {
  private:
  ...
  private:
    ...
    AMI_err substream_merge(AMI_STREAM < T > **instreams,
        unsigned int arity, AMI_STREAM < T > *outstream);
...
template < class T, class Key >
    ...
    const unsigned long bs, const unsigned int ar):arity(ar), level(i),
basesize(bs)
{
...
//copy constructor;
template < class T, class Key >
    em_buffer < T, Key >::em_buffer(const em_buffer & buf):level(buf.level),
basesize(buf.basesize), index(buf.index), arity(buf.arity)
{
...
/************************************************************/
//free the stream array and the streams pointers
template < class T, class Key > em_buffer < T, Key >::~em_buffer()
{
...
template < class T, class Key > void em_buffer < T, Key >::put_streams()
{
...
/************************************************************/
template < class T, class Key > void em_buffer < T, Key >::print_stream_names()
{
    unsigned int i;
...
/************************************************************/
//clean buffer in case some streams have been emptied by deletion
template < class T, class Key > void em_buffer < T, Key >::cleanup()
{
...
/************************************************************/
//delete all streams
template < class T, class Key > void em_buffer < T, Key >::reset()
{
...
template < class T, class Key > AMI_STREAM < T > *em_buffer < T, Key >::sort()
{
...
template < class T, class Key > void em_buffer < T, Key >::print_range()
{
...
/************************************************************/
//print all elements in buffer
template < class T, class Key > void em_buffer < T, Key >::print()
{
...
template < class T, class Key > void em_buffer < T, Key >::print_stream_sizes()
{
