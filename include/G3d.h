...
int G3d_fillHeader(G3D_Map *, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, double, double, double, double, double, double, int, int, int, double, double, double, char *);
...
void G3d_getRegionMap(G3D_Map *, double *, double *, double *, double *, double *, double *);
void G3d_getWindowMap(G3D_Map *, double *, double *, double *, double *, double *, double *);
...
void G3d_coord2tileCoord(G3D_Map *, int, int, int, int *, int *, int *, int *, int *, int *);
...
int G3d_computeClippedTileDimensions(G3D_Map *, int, int *, int *, int *, int *, int *, int *);
