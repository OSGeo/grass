...
run_grass = \
	GISRC=$(RUN_GISRC) \
	GISBASE=$(RUN_GISBASE) \
	GRASS_COLORSDIR=$(RUN_GISBASE)/etc/colors \
	GRASS_ETCDIR=$(RUN_GISBASE)/etc \
	GRASS_FONTSDIR=$(RUN_GISBASE)/fonts \
	GRASS_GRAPHICSDIR=$(RUN_GISBASE)/docs/html \
	GRASS_GUIRESDIR=$(RUN_GISBASE)/gui \
	GRASS_GUISCRIPTDIR=$(RUN_GISBASE)/gui/scripts \
	GRASS_GUIWXDIR=$(RUN_GISBASE)/gui/wxpython \
	GRASS_LOCALEDIR=$(RUN_GISBASE)/locale \
	GRASS_MISCDIR=$(RUN_GISBASE) \
	GRASS_MKDOCSDIR=$(RUN_GISBASE)/docs/mkdocs \
	GRASS_PYDIR=$(RUN_GISBASE)/etc/python \
