...
# The first @test
t.register type=3draster   input=volume_abs1 file="${n1}" start="2001-01-01" increment="1 months"
...
t.register -i type=3draster input=volume_abs2 file="${n2}"
...
t.register -i type=3draster input=volume_abs3 file="${n3}"
...
t.register -i type=3draster input=volume_abs4 file="${n4}"
...
t.register -i type=3draster input=volume_abs5 file="${n5}"
...
t.unregister type=3draster maps=vol_1,vol_2,vol_3,vol_4,vol_5,vol_6
