...
#% required: no
#% multiple: yes
#% options: id,name,band_reference,creator,subproject,temporal_type,creation_time,start_time,end_time,north,south,west,east,nsres,ewres,cols,rows,number_of_cells,min,max
#% answer: start_time
#%end
