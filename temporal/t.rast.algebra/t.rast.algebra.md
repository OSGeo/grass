...
The statement structure is similar to that of
[r.mapcalc](r.mapcalc.html). In this statement, **result** represents
the name of the space time raster dataset (STRDS) that will contain the
result of the calculation that is given as **expression** on the right
side of the equality sign. These expressions can be any valid or nested
...
[r.mapcalc](r.mapcalc.html). All these operations can be assigned to
STRDS or to the map lists resulting of operations between STRDS.
...
STRDS \"Prec\" if the mean temperature specified in STRDS \"Temp\" is
higher than 10 degrees. Computation is performed if STRDS \"Prec\" and
\"Temp\" have equal time stamps. The number of days or fraction of days
...
*[r.mapcalc](r.mapcalc.html), [t.vect.algebra](t.vect.algebra.html),
[t.rast3d.algebra](t.rast3d.algebra.html), [t.select](t.select.html),
...
*[v.overlay](v.overlay.html), [v.buffer](v.buffer.html),
[v.patch](v.patch.html), [r.mapcalc](r.mapcalc.html)*
