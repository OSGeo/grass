...
[r.mapcalc](r.mapcalc.html). Where **result** represents the name of a
...
\'contains\'. Should all (&) conditions for the related maps be true or
is it sufficient to have any (\|) condition that is true. The resulting
