...
t.register -i type=3draster input=precip_abs1 maps=prec_1,prec_2,prec_3,prec_4,prec_5,prec_6 start="2001-01-01" increment="3 months"
t.register --o type=3draster input=precip_abs2 maps=prec_1,prec_2,prec_3,prec_4,prec_5,prec_6
...
t.unregister type=3draster maps=prec_1,prec_2,prec_3,prec_4,prec_5,prec_6
t.unregister type=3draster maps=new_prec_1,new_prec_2,new_prec_3,new_prec_4,new_prec_5,new_prec_6
