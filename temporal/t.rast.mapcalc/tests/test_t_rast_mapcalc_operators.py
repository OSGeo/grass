...
def test_start_time_end_time_operators(mapcalc_session, assert_tinfo):
...
def test_start_time_components(mapcalc_session, assert_tinfo):
...
def test_end_time_components(mapcalc_session, assert_tinfo):
...
def test_start_doy_dow_operators(mapcalc_session, assert_tinfo):
...
def test_end_doy_dow_operators(mapcalc_session, assert_tinfo):
...
def test_map_comparison_operator(mapcalc_session, assert_tinfo):
