...
class TestRasterUnivar(TestCase):
    ...
    def test_with_all_maps(self):
        ...
        univar_text = """id|semantic_label|start|end|mean|min|max|range|mean_of_abs|stddev|variance|coeff_var|sum|null_cells|cells|n
a_1@testing||2001-01-01 00:00:00|2001-04-01 00:00:00|100|100|100|0|100|0|0|0|960000|0|9600|9600
a_2@testing||2001-04-01 00:00:00|2001-07-01 00:00:00|200|200|200|0|200|0|0|0|1920000|0|9600|9600
a_3@testing||2001-07-01 00:00:00|2001-10-01 00:00:00|300|300|300|0|300|0|0|0|2880000|0|9600|9600
a_4@testing||2001-10-01 00:00:00|2002-01-01 00:00:00|400|400|400|0|400|0|0|0|3840000|0|9600|9600
"""
        for ref, res in zip(
            univar_text.split("\n"),
...
"""
    ...
    def test_coarser_resolution(self):
        ...
        univar_text = """id|semantic_label|start|end|mean|min|max|range|mean_of_abs|stddev|variance|coeff_var|sum|null_cells|cells|n
a_2@testing||2001-04-01 00:00:00|2001-07-01 00:00:00|200|200|200|0|200|0|0|0|19200|0|96|96
a_3@testing||2001-07-01 00:00:00|2001-10-01 00:00:00|300|300|300|0|300|0|0|0|28800|0|96|96
a_4@testing||2001-10-01 00:00:00|2002-01-01 00:00:00|400|400|400|0|400|0|0|0|38400|0|96|96
"""
...
"""
    ...
    def test_subset_with_extended_statistics_and_output(self):
        ...
        univar_text = """id|semantic_label|start|end|mean|min|max|range|mean_of_abs|stddev|variance|coeff_var|sum|null_cells|cells|n|first_quartile|median|third_quartile|percentile_10|percentile_97_5
a_2@m2||2001-04-01 00:00:00|2001-07-01 00:00:00|200|200|200|0|200|0|0|0|1920000|0|9600|9600|200|200|200|200|200
a_3@m2||2001-07-01 00:00:00|2001-10-01 00:00:00|300|300|300|0|300|0|0|0|2880000|0|9600|9600|300|300|300|300|300
a_4@m2||2001-10-01 00:00:00|2002-01-01 00:00:00|400|400|400|0|400|0|0|0|3840000|0|9600|9600|400|400|400|400|400
"""
        univar_output = Path("univar_output.txt").read_text()
        ...
        univar_text = """a_2@testing||2001-04-01 00:00:00|2001-07-01 00:00:00|200|200|200|0|200|0|0|0|1920000|0|9600|9600
a_3@testing||2001-07-01 00:00:00|2001-10-01 00:00:00|300|300|300|0|300|0|0|0|2880000|0|9600|9600
a_4@testing||2001-10-01 00:00:00|2002-01-01 00:00:00|400|400|400|0|400|0|0|0|3840000|0|9600|9600
"""
        univar_output = Path("univar_output.txt").read_text()
    ...
    def test_with_zones(self):
        ...
        univar_text = """id|semantic_label|start|end|zone|mean|min|max|range|mean_of_abs|stddev|variance|coeff_var|sum|null_cells|cells|n
a_1@PERMANENT||2001-01-01 00:00:00|2001-04-01 00:00:00|1|100|100|100|0|100|0|0|0|60000|0|600|600
a_1@PERMANENT||2001-01-01 00:00:00|2001-04-01 00:00:00|2|100|100|100|0|100|0|0|0|168000|0|1680|1680
a_1@PERMANENT||2001-01-01 00:00:00|2001-04-01 00:00:00|3|100|100|100|0|100|0|0|0|732000|0|7320|7320
a_2@PERMANENT||2001-04-01 00:00:00|2001-07-01 00:00:00|1|200|200|200|0|200|0|0|0|120000|0|600|600
a_2@PERMANENT||2001-04-01 00:00:00|2001-07-01 00:00:00|2|200|200|200|0|200|0|0|0|336000|0|1680|1680
a_2@PERMANENT||2001-04-01 00:00:00|2001-07-01 00:00:00|3|200|200|200|0|200|0|0|0|1464000|0|7320|7320
a_3@PERMANENT||2001-07-01 00:00:00|2001-10-01 00:00:00|1|300|300|300|0|300|0|0|0|180000|0|600|600
a_3@PERMANENT||2001-07-01 00:00:00|2001-10-01 00:00:00|2|300|300|300|0|300|0|0|0|504000|0|1680|1680
a_3@PERMANENT||2001-07-01 00:00:00|2001-10-01 00:00:00|3|300|300|300|0|300|0|0|0|2196000|0|7320|7320
a_4@PERMANENT||2001-10-01 00:00:00|2002-01-01 00:00:00|1|400|400|400|0|400|0|0|0|240000|0|600|600
a_4@PERMANENT||2001-10-01 00:00:00|2002-01-01 00:00:00|2|400|400|400|0|400|0|0|0|672000|0|1680|1680
a_4@PERMANENT||2001-10-01 00:00:00|2002-01-01 00:00:00|3|400|400|400|0|400|0|0|0|2928000|0|7320|7320
"""
...
"""
    ...
    def test_with_semantic_label(self):
        ...
        univar_text = """id|semantic_label|start|end|mean|min|max|range|mean_of_abs|stddev|variance|coeff_var|sum|null_cells|cells|n
b_1@PERMANENT|S2_B1|2001-01-01 00:00:00|2001-04-01 00:00:00|110|110|110|0|110|0|0|0|1056000|0|9600|9600
b_2@PERMANENT|S2_B1|2001-04-01 00:00:00|2001-07-01 00:00:00|220|220|220|0|220|0|0|0|2112000|0|9600|9600
b_3@PERMANENT|S2_B1|2001-07-01 00:00:00|2001-10-01 00:00:00|330|330|330|0|330|0|0|0|3168000|0|9600|9600
b_4@PERMANENT|S2_B1|2001-10-01 00:00:00|2002-01-01 00:00:00|440|440|440|0|440|0|0|0|4224000|0|9600|9600
"""
        for ref, res in zip(
            univar_text.split("\n"),
            t_rast_univar.outputs.stdout.split("\n"),
...
"""
    ...
    def test_with_spatial_filter_intersects(self):
        ...
        univar_text = """id|semantic_label|start|end|mean|min|max|range|mean_of_abs|stddev|variance|coeff_var|sum|null_cells|cells|n
d_1@stbl||2001-01-01 00:00:00|2001-04-01 00:00:00|100|100|100|0|100|0|0|0|960000|2100|11700|9600
d_2@stbl||2001-04-01 00:00:00|2001-07-01 00:00:00|200|200|200|0|200|0|0|0|120000|11100|11700|600
d_3@stbl||2001-07-01 00:00:00|2001-10-01 00:00:00|300|300|300|0|300|0|0|0|120000|11300|11700|400
d_4@stbl||2001-10-01 00:00:00|2002-01-01 00:00:00|400|400|400|0|400|0|0|0|10000|11675|11700|25
"""
        for ref, res in zip(
            univar_text.split("\n"),
            t_rast_univar.outputs.stdout.split("\n"),
    ...
    def test_with_spatial_filter_contains(self):
        ...
        univar_text = """id|semantic_label|start|end|mean|min|max|range|mean_of_abs|stddev|variance|coeff_var|sum|null_cells|cells|n
d_1@stbl||2001-01-01 00:00:00|2001-04-01 00:00:00|100|100|100|0|100|0|0|0|770000|0|7700|7700
"""
        for ref, res in zip(
            univar_text.split("\n"),
            t_rast_univar.outputs.stdout.split("\n"),
