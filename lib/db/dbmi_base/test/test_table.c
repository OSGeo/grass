...
int test_table(void)
{
    ...
    db_append_table_column(t1, create_column("second", "second column",
            DB_SQL_TYPE_REAL));
    db_append_table_column(t1, create_column("third", "third column",
            DB_SQL_TYPE_DECIMAL));
    ...
    db_set_table_column(t2, 0, create_column("new_first", "new first column",
            DB_SQL_TYPE_DOUBLE_PRECISION));
    db_set_table_column(t2, 1, create_column("new_second", "new second column",
            DB_SQL_TYPE_REAL));
    db_set_table_column(t2, 2, create_column("new_third", "new third column",
            DB_SQL_TYPE_INTEGER));
