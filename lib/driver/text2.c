...
static void transform(double *x, double *y, int ix, int iy, double orig_x,
                      double orig_y)
{
...
static void draw_char(double *px, double *py, unsigned char character,
...
void get_text_ext(const char *string, double *top, double *bot, double *left,
                  double *rite)
{
    struct rectangle box;
