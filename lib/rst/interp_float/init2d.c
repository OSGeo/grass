...
void IL_init_params_2d(struct interp_params *params, FILE * inp,        /*!< input stream */
    ...
    DCELL * ar1, DCELL * ar2, DCELL * ar3, DCELL * ar4, DCELL * ar5, DCELL * ar6,       /*!< arrays for interpolated values (ar1-ar6) */
    ...
    double sm,                  /*!< smoothing */
    char *f1, char *f2, char *f3, char *f4, char *f5, char *f6, /*!< output files (f1-f6) */
    ...
    FILE * t1, FILE * t2, FILE * t3, FILE * t4, FILE * t5, FILE * t6,   /*!< temp files for writing interp. values (t1-t6) */
...
void IL_init_func_2d(struct interp_params *params, grid_calc_fn * grid_f,       /*!< calculates grid for given segment */
