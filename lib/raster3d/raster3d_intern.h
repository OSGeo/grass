...
#define RASTER3D_XDR_DOUBLE_LENGTH                                            \
    8                                 /* Only kept for backward compatibility \
                                       */
...
#define RASTER3D_VALID_XDR_OPTION(o) \
    (((o) == RASTER3D_USE_XDR) || ((o) == RASTER3D_NO_XDR))
...
extern int
    g3d_do_compression; /* RASTER3D_NO_COMPRESSION or RASTER3D_COMPRESSION */
extern int
    g3d_precision; /* RASTER3D_ALLOW_PRECISION or RASTER3D_NO_PRECISION */
...
extern int g3d_vertical_unit_default; /* spatial or temporal units from gis.h,
                                         U_METERS; ..., U_YEARS, ... */
