...
static int test_large_file_zeros(int depths, int rows, int cols,
                                 int tile_size);
static int test_large_file_random(int depths, int rows, int cols,
                                  int tile_size);
static int test_large_file_sparse_random(int depths, int rows, int cols,
                                         int tile_size);
...
int test_large_file_zeros(int depths, int rows, int cols, int tile_size)
{
    ...
    map =
        Rast3d_open_new_opt_tile_size("test_put_get_value_dcell_large_zeros",
                                      RASTER3D_USE_CACHE_XY, &region,
                                      DCELL_TYPE, tile_size);
...
int test_large_file_random(int depths, int rows, int cols, int tile_size)
{
    ...
    DCELL *random_value_vector =
        G_calloc(RAND_VALUE_VECTOR_SIZE, sizeof(DCELL));
    ...
    map =
        Rast3d_open_new_opt_tile_size("test_put_get_value_dcell_large_random",
                                      RASTER3D_USE_CACHE_XY, &region,
                                      DCELL_TYPE, tile_size);
...
int test_large_file_sparse_random(int depths, int rows, int cols,
                                  int tile_size)
{
    int sum = 0;
    int x, y, z, i;
    ...
    map =
        ...
        ("test_put_get_value_dcell_large_sparse_random",
