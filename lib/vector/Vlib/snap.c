...
Vect_snap_lines_list_kdtree(struct Map_info *Map,
    const struct ilist *List_lines, double thresh, struct Map_info *Err)
{
        ...
        for (v = 0; v < Points->n_points - 1; v++) {
            ...
            for (i = 0; i < kd_found; i++) {
                ...
                dist2 =
                    ...
                    x2, y2, 0, 0, NULL, NULL, NULL, &along, &status);
    ...
    for (v = 0; v < Points->n_points; v++) {
        ...
        for (i = 0; i < List->n_values; i++) {
            ...
            tmpdist2 =
                ...
                Points->z[v],
                x1, y1, z1, x2, y2, z2,
                with_z, &tmpx, &tmpy, &tmpz, NULL, &status);
    ...
    for (v = 0; v < Points->n_points - 1; v++) {
        ...
        for (i = 0; i < List->n_values; i++) {
            ...
            dist2 =
                ...
                x2, y2, z2, with_z, NULL, NULL, NULL, &along, &status);
