    ...
    double *dist, double *spdist, double *lpdist)
{
    ...
    if (n_points == 1) {
        distance =
            ...
            points->z[0], with_z, NULL, NULL, NULL, NULL, NULL);
        tpx = points->x[0];
        tpy = points->y[0];
        tpz = points->z[0];
        tdist = sqrt(distance);
        ...
        distance =
            ...
            points->z[1], with_z, NULL, NULL, NULL, NULL, NULL);
        segment = 1;
        ...
        for (i = 1; i < n_points - 1; i++) {
            new_dist = dig_distance2_point_to_line(ux, uy, uz,
                ...
                points->x[i + 1],
                points->y[i + 1],
                points->z[i + 1], with_z, NULL, NULL, NULL, NULL, NULL);
    ...
    double *dist, double *spdist, double *lpdist)
{
    ...
    if (n_points == 1) {
        ...
        distance =
            ...
            points->y[0], points->z[0],
            points->x[1], points->y[1],
            points->z[1], with_z, &tpx, &tpy, &tpz, NULL, NULL);
        ...
        for (i = 1; i < n_points - 1; i++) {
            new_dist = dig_distance2_point_to_line(ux, uy, uz,
                ...
                points->x[i + 1],
                points->y[i + 1],
                points->z[i + 1], with_z, &ttpx, &ttpy, &ttpz, NULL, NULL);
